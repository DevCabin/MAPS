#!/usr/bin/env python3
"""
Standalone Simple Web Demo - No complex imports
"""
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Starting Multi-Agent Product Listing Demo (Standalone)...")
